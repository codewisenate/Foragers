...
- `@days:` optional weekday names within an `@active` range, such as `Saturday` or `Saturday, Sunday`; recurring cards still show according to the active date range and only mark today when the weekday matches
